#+TITLE: A Day with Org-SuperTag — One Person's Complete Workflow
#+AUTHOR: Org-SuperTag Community
#+EMAIL: yibie@users.noreply.github.com
#+OPTIONS: toc:3 num:t

* How to Use This Document

This is not a feature list.  This is /one person's real daily workflow/ with Org-SuperTag,
...
This document assumes you have Org-SuperTag installed.  See the [[file:../README.md][README]] for installation.

中文版：[[file:A-DAY-WITH-ORG-SUPERTAG_CN.org][Org-SuperTag 的一天（中文）]]
...
and Org-SuperTag treats them all as one unified knowledge base.
...
Why separate files?  Because Org-SuperTag queries /across/ all of them.  The file division
is for /my/ brain — Org-SuperTag doesn't care which file a heading lives in.  A =#task= in
...
This is the biggest win of Org-SuperTag over plain Org-mode.  Capture is /fast/ and
...
Why automation matters:  I define the logic once, and Org-SuperTag applies it every time.
...
I spend 60% of my Org-SuperTag time in the Table View.  It behaves like a lightweight
...
I drag tasks between columns as they progress.  Org-SuperTag updates the =status= field
...
This creates a bidirectional link between the current node and the chosen target node.
The reference appears in both nodes' =Refs= column in the Table View.
...
- =org-supertag-sync-directories-mode 'unified= with 10+ directories → switched to vault
...
- [[file:ORG-SUPERTAG-PLUGIN-GUIDE.md][Plugin Guide]] — Build your own extractors and services
