...
** View framework
- Stream rows now show the node creation date and all corresponding =#tags=
  beside the title, while remaining a single-column summary with no body,
  file path, companion index, or underlined buttons.
